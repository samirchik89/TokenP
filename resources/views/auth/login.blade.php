...
@section('content')
        ...
        <div class="form-content">
            <div class="form-items">
                ...
                @if(config('app.is_demo'))
                    <p>Please use the text credentials below to login to demo</p>
                @else
                    <p>If you have account with us, please login or you can click links at the bottom to register as Issuer or Investor</p>
                @endif
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class=" mb-2">
                        <input id="email_address" type="email" placeholder="xyz@gmail.com"
                            class="form-control{{ (isset($errors) && $errors->has('email')) ? ' is-invalid' : '' }}" name="email"
                    ...
                    <div class="">
                        <input id="password" type="password" placeholder="Password"
                            class="mt-3 form-control{{ (isset($errors) && $errors->has('password')) ? ' is-invalid' : '' }}" name="password"
                            required>
                    </div>
    ...
    <script>
        ...
        @if(isset($demoCredentials) && $demoCredentials)
            // Auto-fill with investor credentials by default
