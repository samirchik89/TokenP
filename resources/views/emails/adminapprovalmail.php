                                ...
                                <tr>
                                    <td style="background-color: #ffffff; border-left: 1px solid #e4e4e4; border-right: 1px solid #e4e4e4; border-radius: 5px;">
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="100%">
                                            <tbody>
                                                <tr>
                                                    <td style="text-align: center; padding: 30px 0 15px; border-bottom: 2px dotted #0d104d;"><img src="logo.png" height="80px" /></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="100%">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="text-align: center; padding: 30px 0 10px;">
                                                        <h2 style="font-size: 14px; font-weight: 300; color: #161f2b; margin: 0;">Click here to Sign In</h2>
                                                    </td>
                                                </tr>

                                                <tr>
                                                    <td style="text-align: center; padding: 20px 0 20px;">
                                                        <a href="{{url('/')}}/" style="border: 1px solid #4828f5; background-color: #4828f5;color: #fff;font-size: 14px;font-weight: 600;padding: 15px 30px; border-radius: 5px;
