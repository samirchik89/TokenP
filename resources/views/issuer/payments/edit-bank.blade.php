                ...
                <div class="col-sm-6">
                    <div class="breadcrumb-four" style="text-align: right;">
                        <ul class="breadcrumb">
                            ...
                            <span>Edit Bank Details</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid">
        ...
        <form method="POST" action="{{ route('issuer.updateBankAccount', ['id' => $bank->id]) }}" id="bankFormUnified">
            ...
            <div class="row">
                ...
                <!-- Routing Details -->
                <div class="form-group col-md-6">
                    <label for="user_contract_id">Associate Asset <span class="text-danger">*</span></label>
                    <select name="user_contract_id" id="user_contract_id" class="form-control">
                        <option value="">-- Select Property --</option>
                        @foreach($contracts as $contract)
                            <option value="{{ $contract->id }}"
                                {{ old('user_contract_id', $bank->user_contract_id) == $contract->id ? 'selected' : '' }}>
