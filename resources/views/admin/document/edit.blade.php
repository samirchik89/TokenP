            ...
            <div class="box box-block bg-white">
                ...
                <form class="form-horizontal" action="{{ route('admin.document.update', $document->id) }}" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-10">
                            <input class="form-control" type="number" value="{{ $document->order }}" order="order"
                                required id="order" placeholder="Document order" name="order">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-10">
                            <select class="form-control" name="mandatory" required>
                                <option value="1" {{ $document->mandatory == '1' ? 'selected' : null }}>Mandatory
                                </option>
                                <option value="0" {{ $document->mandatory == '0' ? 'selected' : null }}>Optional</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-10">
                            ...
                            <input type="file" accept="image/*" name="image" class="dropify form-control-file"
                                id="image" aria-describedby="fileHelp" value="{{ $document->image }}">
                        </div>
                    </div>
