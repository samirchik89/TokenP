                ...
                <div class="pro-list-wrap row card-spaceall">
                            ...
                            <div class="card-body pb-0">
                                ...
                                <div class="row view-sell-btn">
                                    <div class="col-md-6">
                                        ...
                                        <a href="{{url('/wallet')}}">
                                            <button type="button" class=" btn1 btn2">Send Offer</button>
                                        </a>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <a href="{{url('/wallet')}}">
                                            <button type="button" class=" btn1 btn2">Buy</button>
                                        </a>
                    ...
                    <div class="col-md-6 card-me">
                        <div class="card card-statistics">
                            ...
                            <div class="card-body pb-0">
                                <div class="row text-center tbl-sen">
                                    <div class="col-md-12 tbl-sen-l">
                                        <table class="table" cellspacing="0">
                                            <tbody>
                                                <tr>
                                                    <td class="td-first">Payment Details</td>
                                                    <td class="td-secound">12</td>
                                                </tr>
                                                <tr>
                                                    <td class="td-first">Dividend Bank Details</td>
                                                    <td class="td-secound">12%</td>
                                                </tr>
                                                <tr>
                                                    <td class="td-first">Investment Profile </td>
                                                    <td class="td-secound">High </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <div class="row view-sell-btn">
                                    <div class="col-md-12" align="center">
                                        ...
                                        <a href="{{url('/investDetail')}}">
                                            <button type="button" class=" btn1 btn2">confirm</button>
                                        </a>
